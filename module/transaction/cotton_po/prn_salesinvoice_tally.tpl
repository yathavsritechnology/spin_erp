				...
				<td valign="top" style="padding-top:0;text-align:center;padding-bottom:0;width:50%;">
					<table border="0" cellpadding="0" cellspacing="0" style="border-collapse:collapse;font-family:verdana;font-size:12px;width:100%;height:100%;">
						<tr style="border-bottom:1px solid #000;height:30px;">
							<td valign="top" style="border-right:1px solid #000;width:50%;padding:2px;">Invoice No :<br /><b><?= $this->CpoNo ?></b></td>
							<td valign="top" style="width:50%;padding:2px;">Dated :<br /><b><?= $this->CpoDate ?></b></td>
						</tr>
						<tr style="border-bottom:1px solid #000;height:30px;">
						...
						<tr style="border-bottom:1px solid #000;height:30px;">
							<td valign="top" style="border-right:1px solid #000;width:50%;padding:2px;">Buyer's Order No :<br /><b><?= $this->SupplierDcNo; ?></b></td>
							<td valign="top" style="width:50%;padding:2px;">Dated :<br /><b><?= $this->SupplierDcDate; ?></b></td>
						</tr>
						<tr style="border-bottom:1px solid #000;height:30px;">
						...
						<tr style="height:30px;">
							<td style="height:10px;padding:2px;" valign="top" colspan="2">Remarks:<br /><?= $this->cRemarks; ?></td>
						</tr>
					</table>
				</td>
			</tr>
				...
				<td colspan="2" valign="top" style="margin:0;padding:0;border-left:1px solid #000;border-right:1px solid #000;border-bottom:1px solid #000;">
					<table border="0" cellpadding="0" cellspacing="0" style="border-collapse:collapse;font-family:verdana;font-size:12px;width:100%;height:100%;">
						...
						<tr style="border-bottom:0px solid #000;height:15px;">
							...
							<td style="text-align:right;border-right:1px solid #000;padding:2px;"><b><?= $rSupplierWt ?></b></td>
							...
							<td style="text-align:right;padding:2px;"><b><?= $rAmount ?></b></td>
						</tr>
                        <?php
                        }
                        ?>
						...
						<tr style="height:15px;">
							...
							<td style="text-align:right;padding:5px 2px 5px 2px;border-top:1px solid #000;border-bottom:1px solid #000;"><b><?= $this->_Amount; ?></b></td>
						</tr>
						...
						<tr style="border-top:1px solid #000;height:15px;page-break-inside:avoid; page-break-after:auto;">
							...
							<td style="border-right:1px solid #000;padding:2px;"></td>
							<td style="text-align:right;padding:2px;border-right:1px solid #000;"><b><?= sprintf("%0.3f", $this->_AmountSupplierWt); ?></b></td>
							<td style="text-align:right;padding:2px;border-right:1px solid #000;"></td>
							<td style="border-right:1px solid #000;padding:2px;"></td>
							<td style="text-align:right;padding:2px;font-weight:bold;"><?= $this->GrandAmount; ?></td>
						</tr>
						</tfoot>
					</table>
				</td>
