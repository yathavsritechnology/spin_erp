	...
	gebo_validation = {
		ttip: function() {
			var ttip_validator = $('.form_validation_ttip').validate({
                ...
                rules: {
                    txt_ItemCode: { required: true, minlength: 3 },
                    txt_ItemName: { required: true,minlength:3},
                    cmb_s_itemgroup: { required: true },
                    cmb_s_uom: { required: true },
                    cmb_s_tax: { required: true }
				},
