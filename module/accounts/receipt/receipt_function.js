function gen_saleslists()
{
    ...
    var msgbox = $("#Customer_Detail");
    //msgbox.html('<img src="' + txt_IMG_URL + '/loading.gif">&nbsp;Checking availability.');
    $.ajax({
        type: 'post',
        url: txt_url_path + "ajax.php",
        data: 'get_customer_list=1&menuid=' + txt_MenuId + '&txt_VoucherId=' + txt_VoucherId + '&cmb_s_customer=' + cmb_s_customer,
        cache: false,
...
function Validation_Form(){
    try{
        ...
        var cmb_s_customer = document.getElementById('cmb_s_customer').value;
        var cmb_receiptmode = document.getElementById('cmb_receiptmode').value;
